...
const TrendingNewAlbums = () => {
  return (
    <div className="px-4 py-6 text-white">
      ...
      <div className="flex size-full flex-col md:flex-row md:space-x-4">
        {/* Top album */}

        <div
          className="relative mt-4 h-[200px] w-full rounded-lg bg-[url('https://media.pitchfork.com/photos/6076fd2e17d37fe4717d4907/16:9/w_1280,c_limit/Olivia-Rodrigo-SOUR.jpeg')] bg-cover bg-center md:size-[300px]"
        ...
        <div className="flex flex-1 flex-col  space-y-2">
          <div
            className="relative mt-4 h-[200px] w-full rounded-lg bg-[url('https://media.pitchfork.com/photos/6076fd2e17d37fe4717d4907/16:9/w_1280,c_limit/Olivia-Rodrigo-SOUR.jpeg')] bg-cover bg-center"
            // src="https://media.pitchfork.com/photos/6076fd2e17d37fe4717d4907/16:9/w_1280,c_limit/Olivia-Rodrigo-SOUR.jpeg"
          >
            <div className="absolute size-full rounded-lg bg-transparent-white opacity-50"></div>

            <div className="absolute top-0 flex size-full flex-col p-4 text-white">
              <p className="flex-1 font-semibold">New Album</p>
              <div className=" flex items-end justify-between">
                <div>
                  <h1 className="font-semibold">SOUR</h1>
                  <p className="text-sm font-light">Olivia Rodrigo • 2021</p>
        ...
        <div className="flex flex-1 flex-col space-y-2">
          ...
          >
            ...
            <div className="absolute top-0 flex size-full flex-col p-4 text-white">
              <p className="flex-1 font-semibold">Top Chart Album</p>
              <div className=" flex items-end justify-between">
                <div>
                  <h1 className="font-semibold">SOUR</h1>
                  <p className="text-sm font-light">Olivia Rodrigo • 2021</p>
